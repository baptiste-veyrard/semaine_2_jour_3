...
def bonjour_monde(liste, nb)
	client = login_twitter
	journalists_picked = pick_journalists(liste, nb)

	journalists_picked.each do |journalist|
		client.update("#{journalist} Sympa votre dernier article! @the_hacking_pro #Bonjour_monde")
	end
end
